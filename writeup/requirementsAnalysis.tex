...
\begin{longtable}{|p{0.55\linewidth}|p{0.4\linewidth}|}
    ...
    \textbf{F05 (Must Have) }
    Allow mentees to request a mentor, who will have strengths matching their       % TODO:Change this to mentee picking mentor
    weaknesses.
    ...
    \textbf{F13 (Must Have) }
    Mentees will be able to either accept one of the meeting start/end times, or        % TODO: Mentee can cancel, mentor can only reschedule
...
\bibliography{requirementsAnalysis.bib}
